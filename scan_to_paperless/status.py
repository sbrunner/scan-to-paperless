...
class Status:
    ...
    __watch_scan_codes_debug: anyio.abc.Awaitable | None = None
    __watch_destination_debug: anyio.abc.Awaitable | None = None
    __watch_sources_debug: anyio.abc.Awaitable | None = None
